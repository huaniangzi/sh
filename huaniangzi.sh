...
echo "| | |_| | |  | \| | | | | \| |__|  /__ | "
echo "                                "
echo -e "\033[96m花娘子一键脚本工具 v1.7.6 （支持Ubuntu/Debian/CentOS/Alpine系统）\033[0m"
...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      mkdir $yuming
      cd $yuming
      wget https://github.com/huaniangzi/sh/raw/main/file/Discuz_X3.5_SC_UTF8_20230520.zip
