clear
    ...
    echo "1.系统信息查询，增加了内核版本显示，美化了界面。"
    echo "2.LDNMP建站，开放了独角数卡网站的搭建功能."
    echo "3.LDNMP建站，优化了备份全站到远端服务器的稳定性."
    echo "4.Docker管理，全局状态信息，添加了所有docker卷的显示."
    echo "------------------------"
    ...
    echo "------------------------"
    echo "2024-01-09   v1.5.2"
    echo "选项4常用工具中添加跑火车屏保，俄罗斯方块，贪吃蛇，太空入侵者三款小游戏"
    echo "------------------------"
    echo "2024-01-10   v1.5.3"
    echo "LDNMP增加了防止源站IP泄露机制，保护源站IP与证书潜在安全隐患"
    echo "------------------------"
    echo "2024-01-12   v1.5.4"
    echo "脚本添加了启动快捷键，命令行输入hua可以快速启动花娘子一键脚本工具"
    echo "面板工具1panel增加了已安装状态，支持查看面板信息修改用户密码，支持卸载面板"
    echo "------------------------"
    echo "2024-01-13   v1.5.5"
    ...
    echo "优化了脚本快捷启动，输入hua快速启动脚本支持任何目录下使用"
    echo "------------------------"
    echo "2024-01-14   v1.5.6"
    echo "面板工具增加了nextcloud网盘的搭建"
    echo "LDNMP建站增加Docke项目！"
    echo "------------------------"
    echo "2024-01-15   v1.5.7"
    echo "外面的世界重新整理数据"
    echo "优化数据！"
    echo "------------------------"
    echo "2024-01-16   v1.5.8"
    echo "新增开设NAT小鸡"
    echo "------------------------"
    echo "2024-01-17   v1.5.9"
    echo "主菜单添加14选项，VPS集群控制系统，可以一键操控所有VPS执行任务。"
    echo "VPS集群控制属于测试版本，请用闲置机器开始体验，有任何问题欢迎留言反馈"
    echo "------------------------"
    echo "2024-01-18   v1.6.0"
    echo "面板工具增加了搜索聚合网站的安装"
    echo "优化了集群控制体验，集群环境备份还原卸载等功能上线"
    echo "------------------------"
    echo "2024-01-19   v1.6.2"
    echo "面板工具增加了私有相册系统的安装"
    echo "面板工具增加了PDF工具大全应用的安装"
    echo "------------------------"
    echo "2024-01-21   v1.6.3"
    ...
    echo "优化了mtproxy的代码"
    echo "------------------------"
    echo "2024-03-13   v1.7.1"
    echo "ldnmp建站中添加lan朋友圈"
    echo "------------------------"
    echo "2024-03-22   v1.7.3"
    echo "系统工具中新增fail2banSSH防御程序，防止你的SSH被暴力破解"
    echo "面板工具加入了PVE开小鸡的面板，感谢oneclickvirt大佬的一键安装脚本"
    echo "------------------------"
    echo "2024-04-05   v1.7.3"
